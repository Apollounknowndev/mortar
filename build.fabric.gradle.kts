...
dependencies {
    ...
    include("maven.modrinth:apollib:${property("deps.apollib")}")
    modImplementation("maven.modrinth:apollib:${property("deps.apollib")}")
...
loom {
    ...
    accessWidenerPath = sc.process(
        rootProject.file("src/main/resources/mortar.ct"),
        "build/processed.ct"
    )
